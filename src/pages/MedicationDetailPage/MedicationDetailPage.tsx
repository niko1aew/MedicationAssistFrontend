...
import { Button, Card, Modal, ConfirmDialog, Loader, ErrorMessage } from '../../components/common';
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <button className={styles.backButton} onClick={() => navigate('/medications')}>
      ...
      <section className={styles.historySection}>
        ...
        {medicationIntakes.length === 0 ? (
          <p className={styles.emptyHistory}>Нет записей о приеме этого лекарства</p>
        ) : (
